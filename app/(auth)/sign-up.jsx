...
const SignUp = () => {
    ...
    return (
        <ImageBackground
            ...
            resizeMode="cover"
        >
            <SafeAreaView style={{ flex: 1, backgroundColor: 'tansparent' }}>
                <ScrollView contentContainerStyle={{ flexGrow: 1, justifyContent: 'center', alignItems: 'center', padding: 20, }}>
                    <View style={{
                        ...
                        {/* Logo Image */}
                        <Image
                            source={images.safespace} // Make sure this points to your logo image
                            style={{ width: 200, height: 150, alignSelf: 'center', marginBottom: 20 }} // Adjust size as needed
                            resizeMode='contain'
                        />
